...
// FreeBSD and NetBSD don't have memalign().
#if !(defined(VGO_freebsd) || defined(VGO_netbsd)) || (FREEBSD_VERS >= FREEBSD_12_2)
...
#  endif /* !(defined(VGO_freebsd) || defined(VGO_netbsd)) || (FREEBSD_VERS >= FREEBSD_12_2) */
